...
final class Version20220224161501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "event" (id BIGINT NOT NULL, actor_id BIGINT DEFAULT NULL, repo_id BIGINT DEFAULT NULL, type VARCHAR(255) CHECK(type IN (\'COM\', \'MSG\', \'PR\')) NOT NULL, count INT NOT NULL, payload TEXT NOT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, comment TEXT DEFAULT NULL, PRIMARY KEY(id))');
